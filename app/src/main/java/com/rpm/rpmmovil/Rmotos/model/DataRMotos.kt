...
data class DataRMotos(val MotoNombre:String, val  ModeloMoto:String, val MarcaMoto:String, val  VersionMoto:Int, val ConsumoMotoLx100km:Int, val  CilindrajeMoto:String)
